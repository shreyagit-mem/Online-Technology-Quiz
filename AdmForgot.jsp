...
<center><input type=text  class="inputtext btn-submit" name=admin placeholder="ID" required="required" />
</b></center><br>

<center>
<center><input type=submit name=sub value=Forgot /></center><br>
<center><a href="Admin.html" style='font-size:10px solid black'>Cancel</a></center><br>
</form>
</div>
</header>
</body>
