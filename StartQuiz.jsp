...
<div class="page-content p-5" id="content">
  ...
  <div class="row text-white">
    <div class="col-lg-7">
    <form method=post   action="StudQues" >
<b><h2> Quiz </h2>
</b><br>
<label for="Tech">Choose Technology:</label>

<select name="Tech" id="Tech">
  <option value="1" name="JAVA" >JAVA</option>
  <option value="2"   name="Python">Python</option>
  <option value="3" name="SQL">SQL</option>
 <option value="4" name="Data Science">Data Science</option>
