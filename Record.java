...
public class Record extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			PreparedStatement ps=con.prepareStatement("SELECT UID,Technology,QuizID,Score FROM review_quiz where Remark='"+rec+"'");
			...
			{
			   out.println("<center><p>Records</p></center>");
			   out.println("<center><table border=1><tr><th>User ID</th><th>Technology</th><th>Quiz ID</th><th>Score</th></tr>");
			   out.println("<tr>");
			   out.println("<td>"+rs.getString(1)+"</td><td>"+rs.getString(2)+"</td><td>"+rs.getString(3)+"</td><td>"+rs.getInt(4)+"</td></td>");
